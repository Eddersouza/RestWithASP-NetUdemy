...
namespace RestWithASPNetUdemy.Controllers
{
    ...
    public class PersonsController : Controller
    {
        ...
        /// <summary>
        /// Get persons in system by first name or last name.
        /// </summary>       
        /// <returns>Persons items in system.</returns>
        ...
        [Authorize("Bearer")]
        [TypeFilter(typeof(HyperMediaFilter))]
        public IActionResult GetByName([FromQuery] string nome, string sortDirection, int pageSize, int page)
        {
            return new OkObjectResult(_personBusiness.FindWithPagedSearch(nome, sortDirection, pageSize, page));
        }
        ...
        [Authorize("Bearer")]
        [TypeFilter(typeof(HyperMediaFilter))]
        public IActionResult GetPagedSearch([FromQuery] string firstName, string lastName)
        {
